        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountManagerId = table.Column<string>(type: "character varying(36)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientId = table.Column<string>(type: "character varying(36)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExternalId = table.Column<string>(type: "text", nullable: false),
                    Name = table.Column<string>(type: "text", nullable: false),
                    HeadId = table.Column<string>(type: "character varying(36)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ManagerId = table.Column<string>(type: "character varying(36)", nullable: true),
                    TeamId = table.Column<string>(type: "character varying(36)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientId = table.Column<string>(type: "character varying(36)", nullable: false),
                    ProjectManagerId = table.Column<string>(type: "character varying(36)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Type = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: false),
                    DepartmentId = table.Column<string>(type: "character varying(36)", nullable: true),
                    TeamLeadId = table.Column<string>(type: "character varying(36)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AdditionalMembersId = table.Column<string>(type: "character varying(36)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedToId = table.Column<string>(type: "character varying(36)", nullable: true),
                    ProjectId = table.Column<string>(type: "character varying(36)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AssignedProjectsId = table.Column<string>(type: "character varying(36)", nullable: false),
                    AssignedTeamsId = table.Column<string>(type: "character varying(36)", nullable: false)
                },
                constraints: table =>
                {
