...
[ListSchema(Title = "Departments", ColumnActions = new [] { ListAction.View, ListAction.Edit, ListAction.Delete }, CommonActions = new [] { ListAction.Search, ListAction.Create, ListAction.ExportXlsx, ListAction.ExportPdf })]
